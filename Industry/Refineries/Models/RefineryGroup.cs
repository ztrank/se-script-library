namespace IngameScript
{
    ...
    partial class Program
    {
        public class RefineryGroup : UserInterface.ISelectable
        {
            ...
            {
                filterList.Add(new MyInventoryItemFilter(MyDefinitionId.Parse("MyObjectBuilder_Ore"), true));
                filterList.Add(new MyInventoryItemFilter(MyDefinitionId.Parse("MyObjectBuilder_Ingot"), true));
            }
            ...
            public RefineryGroup Populate(IMyBlockGroup group)
            {
                ...
                if (this.InputSorters.Any())
                {
                    ...
                    MyConveyorSorterMode mode = this.InputSorters[0].Mode;
